...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/postal.png":[function(require,module,exports) {
module.exports = "/postal.eeb6b6db.png";
...
exports.TitleBlock = exports.TextBlock = exports.ImageBlock = exports.ColumnsBlock = exports.Block = void 0;
...
var TitleBlock = /*#__PURE__*/function (_Block) {
  ...
  _createClass(TitleBlock, [{
    ...
    value: function toHTML() {
      ...
      return row(col("<".concat(tag, ">").concat(this.value, "</").concat(tag, ">")), css(styles));
    }
  }]);
  return TitleBlock;
}(Block);
...
var ImageBlock = /*#__PURE__*/function (_Block2) {
  ...
  _createClass(ImageBlock, [{
    ...
    value: function toHTML() {
      ...
      return row("<img src=\"".concat(this.value, "\" alt=\"").concat(alt, "\" style=\"").concat(css(imageStyles), "\"\">"), css(styles));
    }
  }]);
  return ImageBlock;
}(Block);
...
var TextBlock = /*#__PURE__*/function (_Block4) {
  ...
  _createClass(TextBlock, [{
    key: "toHTML",
    value: function toHTML() {
      return row(col("<p>".concat(this.value, "</p>")), css(this.options.styles));
    }
  }]);
  return TextBlock;
}(Block);
...
var _postal = _interopRequireDefault(require("./assets/postal.png"));
...
}), new _blocks.TextBlock('Крутые уроки по JavaScript тут: <a href="", target="_blank">yakummi</a>', {
  styles: {
...
}), new _blocks.ImageBlock(_postal.default, {
  styles: {
    padding: '2rem 0',
    display: 'flex',
...
exports.model = model;
},{"./assets/postal.png":"assets/postal.png","./classes/blocks":"classes/blocks.js"}],"utils.js":[function(require,module,exports) {
"use strict";
...
function css() {
  ...
  var toSting = function toSting(key) {
    return "".concat(key, ": ").concat(styles[key]);
  };
  return Object.keys(styles).map(toSting).join(';');
}
